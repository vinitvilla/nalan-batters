...
interface DropdownMenuContentProps extends React.ComponentProps<typeof DropdownMenuPrimitive.Content> {
  /**
   * Optional max width for the dropdown content
   * Useful for mobile responsiveness to prevent overflow
   * @default 'max-w-[calc(100%-1rem)]' (mobile-safe)
   */
  maxWidth?: string
}
    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          maxWidth,
          "origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-md",
          className
        )}
        {...props}
      />
...
interface DropdownMenuSubContentProps extends React.ComponentProps<typeof DropdownMenuPrimitive.SubContent> {
  /**
   * Optional max width for the submenu content
   * Useful for mobile responsiveness to prevent overflow
   * @default 'max-w-[calc(100%-1rem)]' (mobile-safe)
   */
  maxWidth?: string
